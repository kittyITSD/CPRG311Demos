 ...
 * threads in program.
 */
public class NumTank extends Thread implements Observer 
{
	//Attributes
	...
	*/
	...
	public void printNumbers()
	{
		...
		{
			System.out.println(numList.get(i) + " -- from: " + this.toString());
		}
	}

	public void run()
	{
		// just wait till we fill up the list, usually we're busy doing something else too...
	}
