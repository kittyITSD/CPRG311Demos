 ...
 * Class Description:  
 */
public class SerializeCompetitorsComplete
{
	//Constants
	...
	{
		SerializeCompetitorsComplete.serializeCompetitorsToFile();
		SerializeCompetitorsComplete.deserializeCompetitorsFromFile();
		SerializeCompetitorsComplete.serializeCompetitorQueueToFile();
		SerializeCompetitorsComplete.deserializeCompetitorQueueFromFile();
		SerializeCompetitorsComplete.printTimes();
	}
}
