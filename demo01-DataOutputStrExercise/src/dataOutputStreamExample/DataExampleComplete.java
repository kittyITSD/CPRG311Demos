 ...
 * Class Definition: 
 */
public class DataExampleComplete
{
	//Constants
	...
	{
		DataExampleComplete.generateRandomNumberFileUnBuffered();
		DataExampleComplete.readIntegerFileInUnBuffered();
		DataExampleComplete.generateRandomNumberFileBuffered();
		DataExampleComplete.readIntegerFileInBuffered();
		DataExampleComplete.printRunTimes();
	}
